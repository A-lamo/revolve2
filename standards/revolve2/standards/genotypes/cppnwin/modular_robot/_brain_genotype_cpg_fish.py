...
class BrainGenotypeCpgFish:
    ...
    def develop_brain(self, body: Body, include_bias: bool) -> BrainCpgNetworkNeighborFish:
        """
        ...
        """
        return BrainCpgNetworkNeighborFish(genotype=self.brain.genotype, body=body, include_bias=include_bias)